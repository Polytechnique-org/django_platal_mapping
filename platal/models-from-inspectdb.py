...
class Accounts(models.Model):
    ...
    user_perms = models.CharField(max_length=96, blank=True, null=True)
    is_admin = models.IntegerField(blank=True, null=True)
    state = models.CharField(max_length=8)
    password = models.CharField(max_length=40, blank=True, null=True)
    token = models.CharField(max_length=32, blank=True, null=True)
    weak_password = models.CharField(max_length=256, blank=True, null=True)
    ...
    directory_name = models.CharField(max_length=255, blank=True, null=True)
...
class Announces(models.Model):
    ...
    promo_min = models.SmallIntegerField()
    promo_max = models.SmallIntegerField()
...
class Axletter(models.Model):
    short_name = models.CharField(unique=True, max_length=16, blank=True, null=True)
    ...
    promo_min = models.SmallIntegerField()
    promo_max = models.SmallIntegerField()
    subset = models.TextField(blank=True, null=True)
...
class ForumInnd(models.Model):
    ...
    uid = models.ForeignKey(Accounts, db_column='uid', blank=True, null=True)
    read_perm = models.CharField(max_length=100, blank=True, null=True)
    write_perm = models.CharField(max_length=100, blank=True, null=True)
...
class FusionaxAnciens(models.Model):
    ...
    promotion_etude = models.SmallIntegerField()
...
class GappsAccounts(models.Model):
    ...
    g_account_id = models.CharField(max_length=16, blank=True, null=True)
    g_account_name = models.CharField(primary_key=True, max_length=256)
    g_domain = models.CharField(max_length=40, blank=True, null=True)
    g_first_name = models.CharField(max_length=40)
    g_last_name = models.CharField(max_length=40)
    g_status = models.CharField(max_length=13, blank=True, null=True)
    g_admin = models.IntegerField(blank=True, null=True)
    g_suspension = models.CharField(max_length=256, blank=True, null=True)
...
class GappsQueue(models.Model):
    ...
    j_parameters = models.TextField(blank=True, null=True)
    r_softfail_date = models.DateTimeField(blank=True, null=True)
    r_softfail_count = models.SmallIntegerField()
    r_result = models.CharField(max_length=256, blank=True, null=True)
...
class GeolocCountries(models.Model):
    ...
    iso_3166_1_num = models.SmallIntegerField(unique=True)
    worldregion = models.CharField(db_column='worldRegion', max_length=2, blank=True, null=True)  # Field name made lowercase.
    country = models.CharField(max_length=255, blank=True, null=True)
    countryen = models.CharField(db_column='countryEn', max_length=255, blank=True, null=True)  # Field name made lowercase.
    capital = models.CharField(max_length=255)
    nationality = models.CharField(max_length=255, blank=True, null=True)
    nationalityen = models.CharField(db_column='nationalityEn', max_length=255, blank=True, null=True)  # Field name made lowercase.
...
class GroupAuth(models.Model):
    ...
    flags = models.CharField(max_length=21, blank=True, null=True)
...
class Groups(models.Model):
    ...
    logo_mime = models.TextField(blank=True, null=True)
...
class LogSessions(models.Model):
    ...
    forward_host = models.CharField(max_length=128, blank=True, null=True)
    flags = models.CharField(max_length=5)
...
class NewsletterIssues(models.Model):
    ...
    sufb_json = models.TextField(blank=True, null=True)
    title = models.CharField(max_length=255)
...
class Newsletters(models.Model):
    ...
    name = models.CharField(max_length=255)
    criteria = models.CharField(max_length=14, blank=True, null=True)
...
class PaymentMethods(models.Model):
    ...
    flags = models.CharField(max_length=12, blank=True, null=True)
...
class ProfileEducationDegreeEnum(models.Model):
    degree = models.CharField(unique=True, max_length=255, blank=True, null=True)
...
class ProfileEducationFieldEnum(models.Model):
    field = models.CharField(unique=True, max_length=255, blank=True, null=True)
...
class ProfileJobEnum(models.Model):
    ...
    siren_code = models.CharField(db_column='SIREN_code', max_length=9, blank=True, null=True)  # Field name made lowercase.
...
class ProfileMergeIssues(models.Model):
    pid = models.ForeignKey('Profiles', db_column='pid', primary_key=True)
    issues = models.CharField(max_length=48, blank=True, null=True)
...
class ProfilePartnersharingEnum(models.Model):
    ...
    name = models.CharField(max_length=255)
    url = models.CharField(max_length=255)
    default_sharing_level = models.CharField(max_length=7, blank=True, null=True)
...
class ProfilePartnersharingSettings(models.Model):
    ...
    sharing_level = models.CharField(max_length=7, blank=True, null=True)
    allow_email = models.CharField(max_length=6, blank=True, null=True)
...
class ProfileVisibilityEnum(models.Model):
    access_level = models.CharField(max_length=7, blank=True, null=True)
    best_display_level = models.CharField(max_length=7, blank=True, null=True)
    display_levels = models.CharField(max_length=24, blank=True, null=True)
...
class Profiles(models.Model):
    ...
    ax_id = models.CharField(max_length=8, blank=True, null=True)
    ...
    axfreetext = models.TextField(blank=True, null=True)
    ...
    email_directory = models.CharField(max_length=255, blank=True, null=True)
...
class RegisterMarketing(models.Model):
    ...
    message_data = models.CharField(max_length=64, blank=True, null=True)
...
class RegisterPending(models.Model):
    ...
    mailorg2 = models.CharField(max_length=255, blank=True, null=True)
